...
class TestEnrichmentPOT(unittest.TestCase):
    """
    Tests the live AI enrichment process for a representative POT file.
    """

    def test_pot_enrichment_structure_and_relevance(self):
        """
        Verifies that the enrichment process produces a structurally correct
        and contextually relevant analysis for a POT file.
        """
        print("\n--- Testing Live POT Enrichment ---")
        
        source_file = Path(__file__).resolve().parent / "source.pot"
        self.assertTrue(source_file.exists(), "Source file 'source.pot' not found.")
        ...
        self.assertIn("coupon", full_analysis_text, "Term 'coupon' not mentioned in the analysis.")
        ...
        print("✅ FULL PASS: POT enrichment test successful.")
